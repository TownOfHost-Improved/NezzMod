...
{
    //private static readonly string BANEDWORDS_FILE_PATH = "./NEZZ-DATA/BanWords.txt";
    ...
    //        try
    //        {
    //            if (!Directory.Exists(@"NEZZ-DATA")) Directory.CreateDirectory(@"NEZZ-DATA");
    ...
    //                File.WriteAllText(BANEDWORDS_FILE_PATH, GetResourcesTxt($"NEZZ.Resources.Config.BanWords.{fileName}.txt"));
    //            }
    //        }
    //        catch (Exception ex)
    //        {
