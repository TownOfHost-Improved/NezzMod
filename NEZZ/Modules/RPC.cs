...
public enum CustomRPC : byte // 185/255 USED
{
    ...
    // Adding Role rpcs that overrides NEZZ section and changing BetterCheck will be rejected
            ...
            case CustomRPC.BetterCheck: // Better Among Us RPC
                {
                    ...
                    var IsBetterHost = reader.ReadBoolean(); // Used to set the player as better host, this should never be flagged for a NEZZ lobby, if it is it's a spoofed RPC
