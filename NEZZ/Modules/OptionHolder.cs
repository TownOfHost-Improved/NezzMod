...
public enum CustomGameMode
{
    ...
    UltimateTeam = 0x04,
    FourCorners = 0x06,
    HidenSeekNEZZ = 0x08, // HidenSeekNEZZ must be after other Gamemodes
    All = int.MaxValue
}
...
public static class Options
{
    ...
    public static CustomGameMode CurrentGameMode
        => GameMode.GetInt() switch
        {
            ...
            6 => CustomGameMode.HidenSeekNEZZ, // HidenSeekNEZZ must be after other Gamemodes
    ...
    public static int GetGameModeInt(CustomGameMode mode)
        => mode switch
        {
            ...
            CustomGameMode.HidenSeekNEZZ => 3, // HidenSeekNEZZ must be after other Gamemodes
            _ => 0
        };
    ...
    [
        ...
        "Hide&SeekNEZZ", // HidenSeekNEZZ must be after other Gamemodes
    ];
    ...
    private static System.Collections.IEnumerator CoLoadOptions()
    {
        ...
        */
        ...
        TextOptionItem.Create(10000055, "MenuTitle.Hide&Seek", TabGroup.ModSettings)
            .SetGameMode(CustomGameMode.HidenSeekNEZZ)
            .SetColor(Color.red);
