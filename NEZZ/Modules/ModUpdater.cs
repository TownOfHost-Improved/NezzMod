...
public class ModUpdater
{
    ...
    private static readonly string URL_Github = "https://api.github.com/repos/Limeau/TownofHost-Optimized";
    ...
    public static bool NewVersionCheck()
    {
        try
        {
            ...
            if (Directory.Exists(oldData) && File.Exists(Path.Combine(Main.NEZZData, "BanWords.txt")))
            {
