...
public class LobbyStartPatch
{
    ...
    {
        LobbyPaintSprite = Utils.LoadSprite("NEZZ.Resources.Images.LobbyPaint.png", 290f);
        DropshipDecorationsSprite = Utils.LoadSprite("NEZZ.Resources.Images.NEZZ_decor.png", 60f);
    }
