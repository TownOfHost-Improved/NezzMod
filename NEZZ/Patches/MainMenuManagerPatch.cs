...
public class MainMenuManagerStartPatch
{
    ...
    private static void Postfix(MainMenuManager __instance)
    {
        ...
        if (amongUsLogo)
        {
            amongUsLogo.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("NEZZ.Resources.Images.NEZZlogo.png");
        }
...
public static class MainMenuManagerPatch
{
    ...
    public static string BGpath => Path.Combine(Main.NEZZData, "background.mp4");
