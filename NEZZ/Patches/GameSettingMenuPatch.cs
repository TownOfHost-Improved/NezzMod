...
public class GameSettingMenuPatch
{
    ...
    public static void StartPostfix(GameSettingMenu __instance)
    {
        ...
        {
            CustomGameMode.HidenSeekNEZZ => Enum.GetValues<TabGroup>().Skip(3).ToArray(),
    ...
    private static void SetupAdittionalButtons(GameSettingMenu __instance)
    {
        ...
        SpriteRenderer.sprite = Utils.LoadSprite("NEZZ.Resources.Images.PresetBox.png", 55f);
        ...
        button.FindChild("Normal").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("NEZZ.Resources.Images.SearchIconActive.png", 100f);
        button.FindChild("Hover").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("NEZZ.Resources.Images.SearchIconHover.png", 100f);
        button.FindChild("Disabled").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("NEZZ.Resources.Images.SearchIcon.png", 100f);
